...
public class Article {
    ...
    public static List<Article> queryList(Integer pageNo, Integer limit, String keyword) {
        ...
        List<Article> list = entityManager().createQuery("select a from Article a where a.content like '%" + keyword + "%' or a.title like '%" + keyword + "%' order by a.updateDate").setFirstResult(pageNo * limit).setMaxResults(limit).getResultList();
        return list;
    }
